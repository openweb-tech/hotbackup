...
<?php echo $topMenu ?>
<div class="container">
<h1><a href="<?php echo __siteurl ?>/?r=servers/server_tasks_list&id=<?php echo $sid ?>"><?php echo $serverName ?></a> / <?php echo $task['title'] ?> <?php echo $_LANG['servers']['(files)'] ?></h1>
<!-- actions menu -->
<form method="post">
<input type="hidden" name="action" value="servers/tasks/update_files_backup">
