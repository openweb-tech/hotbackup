...
<?php echo $topMenu ?>
<div class="container">
<h1><a href="<?php echo __siteurl ?>/?r=servers/server_tasks_list&id=<?php echo $sid ?>"><?php echo $serverName ?></a> / <?php echo $_LANG['tasks']['New Files backup'] ?></h1>
<!-- actions menu -->
<form method="post">
  ...
  <div class="col-md-4">
    ...
    <fieldset class="form-group">
      ...
      <select class="form-control" name="status">
        <option value="1" class="<?php echo $_LANG['actions']['tag_enabled'] ?>">Enabled</option>
